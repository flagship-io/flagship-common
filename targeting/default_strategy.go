...
func (ds DefaultStrategy) ShouldIgnoreTargeting() bool {
	return !isEmptyContextOperator(ds.Targeting.GetOperator()) && ds.ContextValue == nil
}

func (ds DefaultStrategy) Match() (bool, error) {
	return targetingMatchOperator(ds.Targeting.GetOperator(), ds.Targeting.GetValue(), ds.ContextValue)
}
